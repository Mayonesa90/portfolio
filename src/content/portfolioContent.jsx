...
export function PortfolioContent(){
    return(
        <motion.div 
            className="flex flex-col items-center gap-10 font-Lato tracking-wide relative overflow-x-hidden"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1}}
            exit={{ opacity: 0 }}
        ...
        >
            ...
            <h1 className=" tracking-tight mt-6 text-center  text-black font-Lato italic font-extra-bold text-3xl">PRIVATE PROJECTS</h1>
            <div className='flex flex-col'>
